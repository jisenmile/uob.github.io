...
(function (global) {
  ...
  var EN = {
    ...
    sv1p: "Experienced in providing investment education to clients of various ages, regions, and characters, with the ability to adapt communication style to be easy to understand and relevant to each participant. ( in english )",
    sv2no: "Service 02",
  ...
  var ID = {
    ...
    sv1p: "Berpengalaman dalam memberikan edukasi investasi kepada klien dari beragam usia, wilayah, dan karakter, dengan kemampuan menyesuaikan gaya komunikasi agar mudah dipahami dan relevan bagi setiap peserta. ( in indonesian )",
    sv2no: "Layanan 02",
